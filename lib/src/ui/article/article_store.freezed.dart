...
abstract class $ArticleStoreStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ArticleState articleState});
...
class _$_ArticleStoreState implements _ArticleStoreState {
  const _$_ArticleStoreState({required this.articleState});
  ...
  @override
  String toString() {
    return 'ArticleStoreState(articleState: $articleState)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, articleState);
...
abstract class _ArticleStoreState implements ArticleStoreState {
  const factory _ArticleStoreState({required final ArticleState articleState}) =
